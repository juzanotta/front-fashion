...
export function CardProduto({ data }: { data: ProdutoType }) {
    return (
        <div className="card bg-[#E3D5B8] border border-[#C33941] w-full shadow-[#C33941]">
            ...
            <div className="px-7 py-4 start">
                ...
                <p className="font-sans">{data.tamanho} | {Number(data.valor).toLocaleString("pt-br", { minimumFractionDigits: 2 })}</p>
                <div className="card-actions flex justify-between">
                    <div className="mt-auto">
                        {data.marca && (
                            <div className="badge badge-outline mr-2 text-[#C33941]">
                                {data.marca}
                            </div>
                        )}
                        {data.material && (
                            <div className="badge badge-outline text-[#C33941]">
                                {data.material}
                            </div>
                        )}
                    </div>
