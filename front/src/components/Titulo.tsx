            ...
            <div className="navbar shadow-sm px-30 bg-[#FFFFE7] fixed top-0 left-0 w-full h-16 z-50">
                ...
                <div className="flex navbar-end gap-2">
                    ...
                    <div className="dropdown dropdown-end">
                        <Link to="/favoritos" className="btn btn-circle bg-[#FFFFE7] border-[#FFFFE7] text-[#C33941] hover:bg-[#C33941] hover:text-[#FFFFE7] mb-1 ml-4">
                        ...
                        <div tabIndex={0} role="button" className="btn btn-circle bg-[#FFFFE7] border-[#FFFFE7] text-[#C33941] hover:bg-[#C33941] hover:text-[#FFFFE7] mx-2 mb-1">
                            <div className="indicator">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-6">
