...
//     return (
//         <section className="px-30 py-10 bg-[#F1EEE7]">
//             <h1 className="font-serif text-[#C33941] text-6xl w-30 flex justify-end">new in</h1>

            

//             <div className="card bg-[#F1EEE7] border border-[#C33941] w-90 shadow-[#C33941] my-5 ">
...
//                         <div className="btn btn-circle bg-[#F1EEE7] border-[#F1EEE7] text-[#C33941] hover:bg-[#C33941] hover:text-[#F1EEE7]">
